    ...
    <div class="row">
        <div class="col d-flex justify-content-center">
            <div class="border bg-light-subtle rounded-3 px-3 mb-5 w-50">
                <form action="{{ route('dashboard.profile.update', ['profile_id' => $profile->id]) }}" method="post"
                    ...
                    <div class="border-bottom">
                        ...
                        <div class="form-text mb-3">
                            <strong>500x500</strong> px, Maximum size: <strong>2MB</strong>, Format file: <strong>pg,
                                jpeg,
                ...
                <div class="row mb-3">
                    <div class="col d-flex justify-content-center">
                        <form action="" method="post">
                            @csrf
                            @method("PUT")
                            <button type="submit" class="btn btn-light fw-medium mx-3">Set default profile photo
                            </button>
                        </form>
                    </div>
                </div>
