    ...
    <div class="w-100 vh-100 d-flex justify-content-center align-content-center">
        <form method="post" action="{{ route('register.action') }}" class="w-25 d-flex justify-content-center flex-column">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="floatingInput" placeholder="John" value="{{ old('name') }}">
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="floatingPassword" placeholder="Password" {{ old('password') }}>
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="floatingPassword" placeholder="Password" value="{{ old('password_confirmation') }}">
