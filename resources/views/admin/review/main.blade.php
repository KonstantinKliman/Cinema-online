        ...
        <div class="col">
            <table class="table table-hover table-bordered">
                ...
                @foreach($reviews as $index => $review)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td><a href="{{ route('admin-user.page', ['user_id' => $review->user->id]) }}" class="link text-light m-0">{{ $review->user->name }}</a></td>
                        <td><a href="{{ route('admin-review.page', ['review_id' => $review->id]) }}" class="link text-light m-0">{{ $review->title }}</a></td>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <a href="{{ route('admin-edit-review.page', ['review_id' => $review->id]) }}" class="me-1">
