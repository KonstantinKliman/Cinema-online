...
@section('main')
    <x-container>
        <div class="row">
            <div class="col-2 d-flex justify-content-start">
                <img src="{{ asset($movie->poster_file_path) }}" alt="" class="img-fluid">
            </div>
    ...
    @else
        <div class="row d-flex justify-content-center border rounded-3 p-3 mx-1 my-3 bg-light-subtle">
            <div class="col d-flex justify-content-center align-content-center">
                <p class="m-0">To rate the movie you need to confirm your email.</p>
            </div>
        </div>
    @endif
    <x-header>
    ...
    @if($movie->reviews->isEmpty())
        <div class="row d-flex justify-content-center border rounded-3 p-3 mx-1 my-3 bg-light-subtle">
            <div class="col d-flex justify-content-center align-content-center">
                <p class="m-0">There are no reviews here yet. But you can be the first.</p>
            </div>
        </div>
    @else
            ...
            @if($review->is_published)
                <div class="row border rounded-3 p-3 mx-1 my-3 @switch($review->type_id) @case(\App\Enums\ReviewType::positive->value)positive-review-bg @break @case(\App\Enums\ReviewType::negative->value)negative-review-bg @break @case(\App\Enums\ReviewType::neutral->value)neutral-review-bg @break @endswitch">
                    ...
                    <div class="col-11 d-flex flex-column">
                        <h3>
                            <a href="{{ route('profile.page', ['profile_id' => $review->user->profile->id]) }}" class="link">
    ...
    @else
        <div class="row d-flex justify-content-center border rounded-3 p-3 mx-1 my-3 bg-light-subtle">
            <div class="col d-flex justify-content-center align-content-center">
                <p class="m-0">To write a review you need to confirm your email.</p>
            </div>
        </div>
    @endif
@endsection
